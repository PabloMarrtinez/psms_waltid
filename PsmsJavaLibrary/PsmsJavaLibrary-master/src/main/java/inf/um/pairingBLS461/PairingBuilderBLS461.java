...
import inf.um.util.CommonCrypto;
...
public class PairingBuilderBLS461 implements PairingBuilder {
    ...
    private FP hashToFP(byte[] input, String salt) {
        ...
        byte[] hash = HMAC.PBKDF2(HMAC.MC_SHA2, 32, input, salt.getBytes(StandardCharsets.UTF_8), 2, BLS.BFS+CommonCrypto.STATISTICAL_SEC_BYTES);
